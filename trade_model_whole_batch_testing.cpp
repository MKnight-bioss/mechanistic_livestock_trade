                                    ...
                                    for (int j = 0; j < farms[it].traders.size() && break_check != 1; ++j) {
                                        ...
                                        if (partial_rate >= event_rate && break_check != 1) {
                                            ...
                                            //once batch testing is introduced
                                                ...
                                                //are detected for infection. if the number detected >= 1, the batch
                                                //is rejected, otherwise the whole batch is accepted
                                                if (farms[farms[it].traders[j]].disease_state == 1){
                                                    int inf_animals = 0;
                                                    //calc num infected
                                                    ...
                                                    //calc num detected
                                                    for (int det = 0; det < inf_animals; ++det){
                                                    ...
                                                    if (detected_animals > 0.0){
                                                        ...
                                                        //of a batch is the only way for trades to be asymmetrical in
                                                        ...
                                                        //no animals are detected, so the whole batch is accepted
